...
export default function IntroDades() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { dni, name, last_name, birth, tel, gender } = formData;
    if (!dni || !name || !last_name || !birth || !tel || !gender ) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        window.location.href = "../Menu"; // Redirigir a la página de historial
        setFormData({
          dni: "",
          name: "",
          last_name: "",
  ...
  return (
    <div className="FromHistory">
      <h1>Canvia les teves dades personals</h1>
